...
public class GestorCrudFileEnfermLeve implements IGestorCrud{
	 ...
	 * @param path
	 */
	public GestorCrudFileEnfermLeve(List<Enfermedad> list, String path) {
		this.list = list;	
		this.path = path;
	}
	/**
	...
	public void create(Object elemento) {
			list.add((EnfermedadLeve)elemento);
